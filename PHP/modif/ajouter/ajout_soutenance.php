...
<?php include '../../nav.php'?>
    <div class="container mt-5">
        <div class="row text-start">
            <form method="post" action="/PROJET/PHP/modif/ajouter/traitement_ajout/traitement_ajout_soutenir.php">
                ...
                <div class="col-12 text-center">
                    <p>
                        <label for="Idorg" class="fs-3 lll">Idorg</label>
                        <input type="number" name="Idorg" id="Idorg" class="inp">
                    </p>
                </div>
                <div class="col-12 text-center">
                        <p>
                            <label for="dateA" class="fs-3">Date soutenance</label>
                            <input type="date" name="dateA" id="dateA" class="inp">
                        </p>
                    </div>
                <div class="col-12 text-center">
                    <p>
