...
<?php include '../../nav.php'?>
    ...
    <div class="row text-start">
            <form method="post" action ="/PROJET/PHP/modif/changer/traitement_changer/traiitement_changer_professeur.php">
                <div class="col-12 text-center">
                    <p>
                        <label for="Idprof" class="fs-3">Idprof</label>
                        <input type="number" name="Idprof" id="Idprof" class="inp">
                    </p>
                </div>
                <div class="col-12 text-center">
                ...
                <div class="col-12 text-center">
                        <label for="civilites" class="fs-3">Civilité</label><br>
                        <label for="civilite" class="fs-4">Monsieur</label>
                        <input type="radio" name="civilite" id="civilite"value="Mr"><br>
                        <label for="civilite" class="fs-4">Mademoiselle</label>
                        <input type="radio" name="civilite" id="civilite" value="Mlle" ><br>
                ...
                <div class="col-12 text-center gradee">
                        <label for="grade" class="fs-3">Grade</label><br>
                        ...
                        <input type="radio" name="grade" id="grade" value="Maitre de conférence" ><br>
                        <label for="grade" class="fs-4">Assistant d'enseignement Supérieur et de Recherche</label>
                        <input type="radio" name="grade" id="grade" value="Assistant d'enseignement Supérieur et de Recherche"><br>
