<!-- <header class="container-fluid">
  <nav class="navbar navbar-expand-md fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand fs-4" href="#"><span class="logo bg-gradient p-1 rounded-3 text-light">School</span><br>Managment</a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo03" aria-expanded="false" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse  justify-content-end" id="navbarTogglerDemo03">
        ...
        <ul class="navbar-nav mb-5 mt-2 mb-lg-0 ll">
          <li class="nav-item">
            <a class="nav-link active fs-4" aria-current="page" href="#">Acceuil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fs-4" href="#">Liste</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fs-4" aria-disabled="true">Modification</a>
          </li>
        </ul>       
      </div>
    </div>
